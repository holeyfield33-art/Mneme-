...
|----------|--------------------|-----------------|-------|
| `DATABASE_URL` | Yes | `postgresql://username:<PASSWORD>@db-host:5432/dbname` | PostgreSQL connection string |
...
|----------|------------------|-----------------|-------|
| `DATABASE_URL` | Yes | `postgresql://username:<PASSWORD>@localhost:5432/mneme` | PostgreSQL connection string |
| `OPENAI_API_KEY` | Yes | `sk-...` | OpenAI key for embeddings |
...
```dotenv
DATABASE_URL=postgresql://username:<PASSWORD>@localhost:5432/mneme
